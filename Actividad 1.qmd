...
El haber agregado un valor atipico tuvo un efecto en la tendencia. Esta presento un pequeño incremento repentino en su linealidad, el cuál después decrementa, continuando con la tendencia normal. También se nota este cambio en la gráfica de los datos desestacionalizados, ya que claramente hay una inconsistencia en lugar donde se encuentra el valor atípico. Este llega casi hasta los valores máximos de la serie.
